...
Si eres un nuevo ingeniero en Identia.pe que se une a nuestro equipo, te recomendamos como primer paso visitar nuestra página de onboarding: [onboarding.md](onboarding.md).

## Contenido
 
- [Buenas prácticas de desarrollo](good-practices.md)
- [Resumen de repositorios](repos.md)
- [Documentación interna](internal-docs.md)
